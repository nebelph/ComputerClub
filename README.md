...
Входные данные представляют собой текстовый файл. Файл указывается первым аргументом при запуске программы. Файл info.txt содержит пример из ТЗ, файлы test1.txt, ..., test5.txt содержат примеры ошибочных и корректных данных.
